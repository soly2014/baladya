...
@section('content')	
    ...
    'title' => trans('res_quar.edit_res_quar'),
    'icon' => 'dashboard',
    'fil' =>  link_to('admin/res_quar', trans('res_quar.res_quars')) .'  /  '.  trans('res_quar.edit_res_quar')
    ])
        ...
        <div class="panel panel-default panel-shadow" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
            ...
            <div class="panel-heading">
                <div class="panel-title">{{trans('res_quar.edit_res_quar')}}</div>
            </div>
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['url' => url('/admin/res_quar/'.$resQuar->id),'method' => 'PUT','id'=>'formCreate']) !!}	
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                <div class="form-group">
                    {!! Form::controlBootstrap('text', 12, 'name', $errors, '',$resQuar->name,'',trans('res_quar.name')) !!}
                </div>
                <div class="form-group">
                    {!! Form::controlBootstrap('textarea', 12, 'desc', $errors, trans('res_quar.desc'),$resQuar->desc,'',trans('res_quar.desc')) !!}
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::selectBootstrap('status',[0=>trans('res_quar.inactive'),1=>trans('res_quar.active')],$resQuar->status,trans('res_quar.status')) !!}
                    </div>
                </div>
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                      <input type="text" class="form-control" id="us3-address" name="map" value="{{$resQuar->map}}"/>
                                    @if ($errors->has('map'))
                              ...
                              <div class="m-t-small">
                                  ...
                                  <div class="col-sm-3">
                                      <input type="text" class="form-control" style="width: 110px" id="us3-lat" name="lat" value="{{$resQuar->lat}}"/>
                                  </div>
                                  <label class="p-r-small col-sm-2 control-label">{{trans('street.long')}}</label>

                                  <div class="col-sm-3">
                                      <input type="text" class="form-control" style="width: 110px" id="us3-lon" name="long" value="{{$resQuar->long}}"/>
                                  </div>
                              </div>
