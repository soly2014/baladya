		...
		<div class="row">
            ...
            <div class="panel-body">
                ...
                <div class="panel-body">
						...
						<form role="form" class="form-horizontal form-groups-bordered" action="{{ url('/admin/violation') }}/{{$violation->id}}" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-4" name="custom_penalty" placeholder="{{trans('violation.custom_penalty')}}" value="{{ old('custom_penalty')?:$violation->custom_penalty }}">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<input name="images[]" type="file" class="form-control file2 inline btn btn-primary" multiple="5" data-label="<i class='glyphicon glyphicon-circle-arrow-up'></i> &nbsp;Browse Files" />
