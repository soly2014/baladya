    ...
    <nav id="navigation" class="navigation site-nav">
        <div class="nav-container">
            ...
            <ul class="onstart animated" id="menu" data-animation="fadeInDown" data-animation-delay="800">
                <li class="active" data-menuanchor="firstPage"><a href="#firstPage" class="active">عن مشروع البلدية</a></li>
                <li data-menuanchor="secondPage"><a href="#secondPage">برنامج مراقبة الخدمات</a></li>
                 <li data-menuanchor="3rdPage"><a href="#3rdPage">تتبع سيارات</a></li>
