...
@section('content')	
    ...
    'title' => trans('gardens.create_garden'),
    'icon' => 'dashboard',
    'fil' =>  link_to('admin/gardens', trans('gardens.gardens')) .'  /  '.  trans('gardens.create_garden')
    ])
		...
		<div class="panel panel-default panel-shadow" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
            ...
            <div class="panel-heading">
                <div class="panel-title">{{trans('gardens.create_garden')}}</div>
            </div>
...
<div class="panel-body">
	...
	<form role="form" id="formCreate" class="form-horizontal form-groups-bordered" action="{{ url('/admin/gardens') }}" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="field-4" name="name" placeholder="الاسم" value="{{ old('name') }}">
				@if ($errors->has('code'))
					<span class="error">
...
<div class="form-group" >
	...
	<div class="col-sm-5" id="pushStreets">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<textarea class="form-control" id="field-4" name="desc" placeholder="الوصف">{{ old('desc') }}</textarea>
			</div>
		</div>
